...
class DefaultLicensePlateWidget extends WidgetBase
{
    ...
    public function settingsSummary()
    {
        ...
        $summary[] = $this->t(
            'License plate size: @number (for number) and @code (for code)', [
     ...
     */
    protected function addCodeField(array &$element, FieldItemListInterface $items, int $delta, array $placeholder_settings)
    {
